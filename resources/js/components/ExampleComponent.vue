<template>
<table class="divide-y divide-gray-200 border-solid border-2 border-black">
    <thead>
        <tr>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        <tr v-for="progression in progressions" :key="progression.id">
            ...
            <td class="px-6 py-4 whitespace-nowrap">{{progression.poids}}</td>
            <td class="px-6 py-4 whitespace-nowrap">{{progression.height}}</td>
            <td class="px-6 py-4 whitespace-nowrap">{{progression.biceps}}</td>
